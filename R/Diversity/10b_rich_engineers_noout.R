...
writeRaster(cu_cont_ecoser_rich, 
            paste0("./Diversity/Richness/Ams/cu_cont_noout_engineers_Ams.tif"),
            format="GTiff", overwrite=T)

writeRaster(cu_cont_ecoser_rich_BR, 
            paste0("./Diversity/Richness/BR_noout/cu_cont_noout_engineers.tif"),
            format="GTiff", overwrite=T)

writeRaster(cu_cont_ecoser_rich_SP, 
            paste0("./Diversity/Richness/SP_noout/cu_cont_noout_engineers.tif"),
            format="GTiff", overwrite=T)

writeRaster(cu_bin_ecoser_rich, 
            paste0("./Diversity/Richness/Ams/cu_bin_noout_engineers_Ams.tif"),
            format="GTiff", overwrite=T)

writeRaster(cu_bin_ecoser_rich_BR, 
            paste0("./Diversity/Richness/BR_noout/cu_bin_noout_engineers.tif"),
            format="GTiff", overwrite=T)

writeRaster(cu_bin_ecoser_rich_SP, 
            paste0("./Diversity/Richness/SP_noout/cu_bin_noout_engineers.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_cont_ecoser_rich, 
            paste0("./Diversity/Richness/Ams/fu_cont_noout_engineers_Ams.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_cont_ecoser_rich_BR, 
            paste0("./Diversity/Richness/BR_noout/fu_cont_noout_engineers.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_cont_ecoser_rich_SP, 
            paste0("./Diversity/Richness/SP_noout/fu_cont_noout_engineers.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_bin_ecoser_rich, 
            paste0("./Diversity/Richness/Ams/fu_bin_noout_engineers_Ams.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_bin_ecoser_rich_BR, 
            paste0("./Diversity/Richness/BR_noout/fu_bin_noout_engineers.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_bin_ecoser_rich_SP, 
            paste0("./Diversity/Richness/SP_noout/fu_bin_noout_engineers.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_cu_cont, 
            paste0("./Diversity/Richness/Diff_BR_noout/fu_cu_cont_noout_engineers.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_cu_bin, 
            paste0("./Diversity/Richness/Diff_BR_noout/fu_cu_bin_noout_engineers.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_cu_cont_SP, 
            paste0("./Diversity/Richness/Diff_SP_noout/fu_cu_cont_noout_engineers.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_cu_bin_SP, 
            paste0("./Diversity/Richness/Diff_SP_noout/fu_cu_bin_noout_engineers.tif"),
            format="GTiff", overwrite=T)
