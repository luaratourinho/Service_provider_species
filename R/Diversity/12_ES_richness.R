...
cu_cont_list <- str_subset(list.var, "^./Diversity/Richness/BR/cu_cont_")
...
fu_cont_list <- str_subset(list.var, "^./Diversity/Richness/BR/fu_cont_")
...
cu_bin_list <- str_subset(list.var, "^./Diversity/Richness/BR/cu_bin_")
...
fu_bin_list <- str_subset(list.var, "^./Diversity/Richness/BR/fu_bin_")
