...
ggsave(
  arrange_1_6,
  file = "./Figures/Richness_ES_arrange_1_6_bin.tiff",
  height = 90,
  width = 65,
  units = "cm"
)
...
ggsave(
  arrange_7_12,
  file = "./Figures/Richness_ES_arrange_7_12_bin.tiff",
  height = 90,
  width = 65,
  units = "cm"
)
...
ggsave(
  arrange_1_6,
  file = "./Figures/Richness_ES_arrange_1_6_cont.tiff",
  height = 90,
  width = 65,
  units = "cm"
)
...
ggsave(
  arrange_7_12,
  file = "./Figures/Richness_ES_arrange_7_12_cont.tiff",
  height = 90,
  width = 65,
  units = "cm"
)
