...
writeRaster(cu_cont_ecoser_rich, 
            paste0("./Diversity/Richness/Ams/cu_cont_sentinel_Ams.tif"),
            format="GTiff", overwrite=T)

writeRaster(cu_cont_ecoser_rich_BR, 
            paste0("./Diversity/Richness/BR/cu_cont_sentinel.tif"),
            format="GTiff", overwrite=T)

writeRaster(cu_cont_ecoser_rich_SP, 
            paste0("./Diversity/Richness/SP/cu_cont_sentinel.tif"),
            format="GTiff", overwrite=T)

writeRaster(cu_bin_ecoser_rich, 
            paste0("./Diversity/Richness/Ams/cu_bin_sentinel_Ams.tif"),
            format="GTiff", overwrite=T)

writeRaster(cu_bin_ecoser_rich_BR, 
            paste0("./Diversity/Richness/BR/cu_bin_sentinel.tif"),
            format="GTiff", overwrite=T)

writeRaster(cu_bin_ecoser_rich_SP, 
            paste0("./Diversity/Richness/SP/cu_bin_sentinel.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_cont_ecoser_rich, 
            paste0("./Diversity/Richness/Ams/fu_cont_sentinel_Ams.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_cont_ecoser_rich_BR, 
            paste0("./Diversity/Richness/BR/fu_cont_sentinel.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_cont_ecoser_rich_SP, 
            paste0("./Diversity/Richness/SP/fu_cont_sentinel.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_bin_ecoser_rich, 
            paste0("./Diversity/Richness/Ams/fu_bin_sentinel_Ams.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_bin_ecoser_rich_BR, 
            paste0("./Diversity/Richness/BR/fu_bin_sentinel.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_bin_ecoser_rich_SP, 
            paste0("./Diversity/Richness/SP/fu_bin_sentinel.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_cu_cont, 
            paste0("./Diversity/Richness/Diff_BR/fu_cu_cont_sentinel.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_cu_bin, 
            paste0("./Diversity/Richness/Diff_BR/fu_cu_bin_sentinel.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_cu_cont_SP, 
            paste0("./Diversity/Richness/Diff_SP/fu_cu_cont_sentinel.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_cu_bin_SP, 
            paste0("./Diversity/Richness/Diff_SP/fu_cu_bin_sentinel.tif"),
            format="GTiff", overwrite=T)
