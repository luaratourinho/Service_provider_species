...
list.var <-
  list.files(paste0("./Diversity/Richness/BR"),
             recursive = TRUE,
             pattern = "tif",
             full.names = TRUE
  )
...
Classic_results <- matrix(nrow = n, ncol = 20)
...
for(i in 1:n){
  ...
  cu_cont_list <- str_subset(list.var, 
                             paste0("./Diversity/Richness/BR/cu_cont_",
                                    ES[i],".tif"))
  ...
  fu_cont_list <- str_subset(list.var, 
                             paste0("./Diversity/Richness/BR/fu_cont_",
                                    ES[i],".tif"))
  ...
  cu_bin_list <- str_subset(list.var, 
                             paste0("./Diversity/Richness/BR/cu_bin_",
                                    ES[i],".tif"))
  ...
  fu_bin_list <- str_subset(list.var, 
                            paste0("./Diversity/Richness/BR/fu_bin_",
                                   ES[i],".tif"))
  ...
  fu_cu_cont_list <- str_subset(list.var_2, 
                             paste0("./Diversity/Richness/Diff_BR/fu_cu_cont_",
                                    ES[i],".tif"))
...
cu_cont_list <- str_subset(list.var, 
                           paste0("./Diversity/Richness/BR/cu_cont_ES.tif"))
...
fu_cont_list <- str_subset(list.var, 
                           paste0("./Diversity/Richness/BR/fu_cont_ES.tif"))
...
cu_bin_list <- str_subset(list.var, 
                          paste0("./Diversity/Richness/BR/cu_bin_ES.tif"))
...
fu_bin_list <- str_subset(list.var, 
                          paste0("./Diversity/Richness/BR/fu_bin_ES.tif"))
...
fu_cu_cont_list <- str_subset(list.var_2, 
                              paste0("./Diversity/Richness/Diff_BR/fu_cu_cont_ES.tif"))
...
fu_cu_bin_list <- str_subset(list.var_2, 
                             paste0("./Diversity/Richness/Diff_BR/fu_cu_bin_ES.tif"))
...
write.csv(Classic_results_1, "./Table_results/13_ES_table_S2.csv", row.names = F)
