...
# riq.serv.p.cer_2 <- raster("./Diversity/Richness/BR/cu_bin_ES.tif")
...
delta.serv <- raster("./Diversity/Richness/Diff_BR/fu_cu_bin_ES.tif")
...
write.csv(tab.mud, "./Diversity/delta_beta/15_delta_results.csv", row.names = F)
...
writeRaster(beta.sim.r, 
            "./Diversity/beta/beta_sim_r.tif",
            format="GTiff", overwrite=T)

writeRaster(beta.nes.r, 
            "./Diversity/beta/beta_nes_r.tif",
            format="GTiff", overwrite=T)

writeRaster(beta.sor.r, 
            "./Diversity/beta/beta_sor_r.tif",
            format="GTiff", overwrite=T)
