...
for(i in 1:n){
  ...
  writeRaster(diff_bin2, filename = paste0("./ENM/Diff_raster/Am/", sp_names[i],
                                          "_diff_bin.tif"),
  ...
  writeRaster(diff_cont, filename = paste0("./ENM/Diff_raster/Am/", sp_names[i],
                                           "_diff_cont.tif"),
              format="GTiff", overwrite=T)
...
write.csv(Results_diff_area, "./ENM/Diff_raster/Am/14_area_sp.csv", row.names = F)
