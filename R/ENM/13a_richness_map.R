...
sp_names <- read_csv("./Table_results/12_sp_table_S1_less15onlycharis.csv")
...
writeRaster(cu_rich_Ams, filename = 
              paste0("./Diversity/Richness/Ams/Species/cu_rich.tif"),
            format="GTiff", overwrite=T)
writeRaster(cu_rich_BR, filename = 
              paste0("./Diversity/Richness/BR/Species/cu_rich.tif"),
            format="GTiff", overwrite=T)
writeRaster(cu_rich_SP, filename = 
              paste0("./Diversity/Richness/SP/Species/cu_rich.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_rich_Ams, filename = 
              paste0("./Diversity/Richness/Ams/Species/fu_rich.tif"),
            format="GTiff", overwrite=T)
writeRaster(fu_rich_BR, filename = 
              paste0("./Diversity/Richness/BR/Species/fu_rich.tif"),
            format="GTiff", overwrite=T)
writeRaster(fu_rich_SP, filename = 
              paste0("./Diversity/Richness/SP/Species/fu_rich.tif"),
            format="GTiff", overwrite=T)

writeRaster(cu_cont_rich_Ams, filename = 
              paste0("./Diversity/Richness/Ams/Species/cu_cont_rich_Ams.tif"),
            format="GTiff", overwrite=T)
writeRaster(cu_cont_rich_BR, filename = 
              paste0("./Diversity/Richness/BR/Species/cu_cont_rich.tif"),
            format="GTiff", overwrite=T)
writeRaster(cu_cont_rich_SP, filename = 
              paste0("./Diversity/Richness/SP/Species/cu_cont_rich.tif"),
            format="GTiff", overwrite=T)

writeRaster(fu_cont_rich_Ams, filename = 
              paste0("./Diversity/Richness/Ams/Species/fu_cont_rich_disp.tif"),
            format="GTiff", overwrite=T)
writeRaster(fu_cont_rich_BR, filename = 
              paste0("./Diversity/Richness/BR/Species/fu_cont_rich.tif"),
            format="GTiff", overwrite=T)
writeRaster(fu_cont_rich_SP, filename = 
              paste0("./Diversity/Richness/SP/Species/fu_cont_rich.tif"),
            format="GTiff", overwrite=T)

writeRaster(diff_rich_BR, filename = 
              paste0("./Diversity/Richness/BR/Species/diff_rich.tif"),
            format="GTiff", overwrite=T)
writeRaster(diff_rich_SP, filename = 
              paste0("./Diversity/Richness/SP/Species/diff_rich.tif"),
            format="GTiff", overwrite=T)
...
ggsave(
  p_arrange,
  file = "./Figures/Richness_species_cu_fu_less15onlycharis.tiff",
  height = 15,
  width = 30,
  units = "cm"
)
...
ggsave(
  p[[3]],
  file = "./Figures/Richness_species_diff_less15onlycharis.tiff",
  height = 17,
  width = 18,
  units = "cm"
)
